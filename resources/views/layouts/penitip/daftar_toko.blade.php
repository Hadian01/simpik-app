...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <button class="btn btn-outline-secondary" data-toggle="modal" data-target="#modalFilterToko">
            ...
            <div class="modal-content">
                <form id="formFilterToko">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" id="resetFilterToko">Reset</button>
