            ...
            <div class="modal-body">
                ...
                <ul class="list-group mb-4">
                    ...
                    <li class="list-group-item">
                        ...
                        <small class="text-muted">
                            {{ $latest_pengajuan
                                ? \Carbon\Carbon::parse($latest_pengajuan->created_at)->timezone('Asia/Jakarta')->format('d F Y H:i')
                                : '-' }}
                        </small>
                ...
                @if ($status === 'rejected')
                    <div class="alert alert-danger">
                        ...
                        {{ $latest_pengajuan && $latest_pengajuan->alasan ? $latest_pengajuan->alasan : 'Tidak ada catatan' }}
                ...
                <div class="text-center">
                    ...
                    @if ($status === 'rejected')
                        <button class="btn btn-warning ml-2" data-toggle="modal" data-target="#modalJoin"
                            data-dismiss="modal">
                            Ajukan Ulang
                        </button>
                    @endif
